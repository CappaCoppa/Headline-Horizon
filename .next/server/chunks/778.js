...
var reactIs = __webpack_require__(4828);
...
module.exports = createProxy("C:\\Users\\lukva\\Desktop\\projects\\Headline-Horizon\\node_modules\\next\\dist\\client\\components\\app-router.js");
 //# sourceMappingURL=app-router.js.map
...
// UNUSED EXPORTS: createSelectorHook, initializeUseSelector

// EXTERNAL MODULE: external "next/dist/compiled/react"
var react_ = __webpack_require__(8038);
;// CONCATENATED MODULE: ./node_modules/react-redux/es/components/Context.js

const ContextKey = Symbol.for(`react-redux-context-${react_.version}`);
const gT = globalThis;
...
function getContext() {
  ...
  if (!realContext) {
    realContext = (0,react_.createContext)(null);
...
function createReduxContextHook(context = ReactReduxContext) {
  return function useReduxContext() {
    const contextValue = (0,react_.useContext)(context);
...
function createSelectorHook(context = ReactReduxContext) {
  ...
  return function useSelector(selector, equalityFnOrOptions = {}) {
    ...
    const firstRun = (0,react_.useRef)(true);
    const wrappedSelector = (0,react_.useCallback)({
      [selector.name](state) {
    ...
    (0,react_.useDebugValue)(selectedState);
