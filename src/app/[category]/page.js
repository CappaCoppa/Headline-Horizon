			...
			if (index % 3 === 0) {
					...
					return (
						<div
							...
							<Link
								...
								/>
								<h6 className=" lg:text-h5 cursor-pointer transition-all hover:underline font-semibold tracking-wider font-antic text-primary py-8 uppercase">
									{article.headline}
								</h6>
				...
				return (
					<div className="border-b-[1px] border-black-10 py-16">
						...
						<div className=" gap-8 grid col-span-1">{mappedArticles}</div>
						<Link href={`/${title}/${sub_category.title}`}>
							<p className="text-h6 font-antic text-right cursor-pointer text-secondary hover:text-primary transition-all ease-in-out duration-300 mt-16">
								View more
							</p>
		...
		<div className="bg-black-5 p-16 lg:px-32 lg:py-32">
			<div className="px-16 md:px-64 pb-32 grid col-span-2 border-b-[1px] border-black-10">
				...
				<h2 className="text-h7 md:text-h6 text-black-50">
					{" "}
					Welcome to the Lifestyle section of Headline Horizon, your reliable
					source for embracing the quintessential American way of life. Are you
					seeking time-honored recipes and fine beverages in our Food and Drink
					segment? Intrigued by sturdy Cars and dependable Trucks? Yearning for
					the freedom of Travel and the tranquility of the Outdoors, or the
					comfort of your House and Home? Eager to improve your Fitness and
					elevate your Well-being, or stay updated with tasteful Style and
					timeless Beauty? Need wisdom on nurturing Family values or seeking
					spiritual enrichment through Faith? Discover all this and more in our
					carefully crafted categories. Join us on this journey, and experience
