...
const mappedTopArticles = () =>
  objectsArray.map((article, index) => {
    const truncatedArticle = article.Article.slice(0, 200) + "...";
    ...
    return (
      <div key={index}>
        ...
        /> */}
        <h3 className="font-antic cursor-pointer transition-all hover:underline text-black-10 border-b pb-16 mb-16 uppercase">
          {article.Headline}
        </h3>
        <h7 className="text-black-25 cursor-pointer">{truncatedArticle}</h7>
        <br />
        <button className="mt-16">
          <h7 className="hover:bg-secondary-opacity-0.20 transition ease-in-out p-8 text-black-25 border-black-25 border-[1px] uppercase">
            More
          </h7>
        </button>
      </div>
...
const mappingNormalArticles = () =>
  objectsArray.map((article, index) => {
    const truncatedArticle = article.Article.slice(0, 300) + "...";
    return (
      <div
        key={index}
        className="cursor-pointer transition ease-in-out hover:bg-black-10 p-8"
      >
        <Image
          width={500}
          height={500}
          ...
          alt={article.images[0].alt}
        />
        <h4 className=" cursor-pointer transition-all hover:underline font-antic text-primary border-b py-8 mb-8 uppercase">
          {article.Headline}
        </h4>
        <h7 className="cursor-pointer text-h7 text-black-75">
          {truncatedArticle}
        </h7>
        <div className=" flex mt-32 justify-between">
          <h7 className=" uppercase text-primary">{article.dateTime}</h7>
...
export default function Home() {
  return (
    <main className="">
      ...
      <div className="p-64 bg-black-opacity-0.50 grid grid-cols-3 grid-rows-2 gap-32">
        {mappedTopArticles()}
      </div>
      <div className="p-64 bg-black-5 grid grid-cols-3 gap-32">
        {mappingNormalArticles()}
      </div>
    </main>
  );
}
